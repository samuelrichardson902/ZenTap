...
class ScheduleAlarmReceiver : BroadcastReceiver() {
    ...
    private fun isTodayInRepeatDays(repeatDays: Set<com.example.zentap.data.DayOfWeek>): Boolean {
        ...
        val today = when (calendar.get(Calendar.DAY_OF_WEEK)) {
            Calendar.MONDAY -> com.example.zentap.data.DayOfWeek.MONDAY
            Calendar.TUESDAY -> com.example.zentap.data.DayOfWeek.TUESDAY
            Calendar.WEDNESDAY -> com.example.zentap.data.DayOfWeek.WEDNESDAY
            Calendar.THURSDAY -> com.example.zentap.data.DayOfWeek.THURSDAY
            Calendar.FRIDAY -> com.example.zentap.data.DayOfWeek.FRIDAY
            Calendar.SATURDAY -> com.example.zentap.data.DayOfWeek.SATURDAY
            Calendar.SUNDAY -> com.example.zentap.data.DayOfWeek.SUNDAY
            else -> null
        }
